...
export const Component = ({ property1, className }) => {
	const props = [
		...
		[
			<>
				Чтобы узнать, что читают ваши друзья, вы сможете подписаться <br />
				на их профиль и следить <br />
				за обновлениями
			</>,
			1,
			407,
		...
		[
			<>
				Все разделы и подборки, включая личные, регулярно обновляются <br />с
				выходом новых книг
			</>,
			2,
			367,
		...
		[
			<>
				Ваша личная подборка создается <br />
				на основе результатов пройденного теста и регулярно обновляется
			</>,
			3,
			437,
		],
	...
	return (
		<div className={`component property-1-2-${property1} ${className}`}>
